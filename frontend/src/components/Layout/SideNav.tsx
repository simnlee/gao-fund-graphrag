      ...
      setMessages([
        {
          ...
          id: 2,
          message:
            'Welcome to the GAO Fund Newsletter Chatbot. You can ask questions related to documents which have been completely processed. Try to make your question as specific as possible. If an answer does not fully address your query, you can ask for more details',
          user: 'chatbot',
        },
      ]);
    }
